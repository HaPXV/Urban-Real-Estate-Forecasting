...
This repository is a **concise ICCE 2026 paper artifact** for:

**"A Multi-Source Framework for Forecasting Urban Real Estate Trends in Ho Chi Minh City"**.

It is intentionally scoped for reviewer verification, not as a full research/thesis codebase.
...
## Supporting (non-numbered) artifacts
